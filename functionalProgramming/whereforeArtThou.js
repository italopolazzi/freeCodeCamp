...
/**
 * Looks through an array of objects(first argument) and returns an array of all objects that have matching name and value pairs
 * @param {Object} collection the main object which will be used to search for the pair of key/value
 * @param {Object} source the object with the pairs of key/value to search
 * @return {Array<object>} an array of all objects that have matching name and value pairs
 */
